...
export type GlobalSessionList = Array<GlobalSession>
...
export type GlobalConfigReplaceData = {
  body?: Config
  path?: never
  query?: never
  url: "/global/config"
...
export type GlobalConfigReplaceErrors = {
  /**
   * BadRequest | InvalidRequestError
   */
  400: EffectHttpApiErrorBadRequest | InvalidRequestError
...
export type GlobalConfigReplaceError = GlobalConfigReplaceErrors[keyof GlobalConfigReplaceErrors]

export type GlobalConfigReplaceResponses = {
  /**
   * Successfully replaced global config
   */
  200: Config
}

export type GlobalConfigReplaceResponse = GlobalConfigReplaceResponses[keyof GlobalConfigReplaceResponses]
...
export type ConfigProviderModelsData = {
  body?: never
  path: {
    providerID: string
  }
  ...
  url: "/config/providers/{providerID}/models"
}

export type ConfigProviderModelsErrors = {
  /**
   * Bad request
   */
  400: BadRequestError
...
export type ConfigProviderModelsError = ConfigProviderModelsErrors[keyof ConfigProviderModelsErrors]

export type ConfigProviderModelsResponses = {
  /**
...
export type ConfigProviderModelsResponse = ConfigProviderModelsResponses[keyof ConfigProviderModelsResponses]
...
export type SessionRegenerateTitleResponses = {
  /**
   * Session with regenerated title
   */
  200: Session
}
