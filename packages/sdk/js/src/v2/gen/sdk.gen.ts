...
import type {
  ...
  ConfigGetErrors,
  ConfigGetResponses,
  ConfigProviderModelsErrors,
  ConfigProviderModelsResponses,
  ...
  GlobalConfigReplaceErrors,
  GlobalConfigReplaceResponses,
...
export class Config extends HeyApiClient {
   ...
   *
   * Replace global OpenCode configuration settings and preferences.
   */
  public replace<ThrowOnError extends boolean = false>(
    ...
    const params = buildClientParams([parameters], [{ args: [{ key: "config", map: "body" }] }])
    return (options?.client ?? this.client).put<GlobalConfigReplaceResponses, GlobalConfigReplaceErrors, ThrowOnError>({
      url: "/global/config",
      ...options,
      ...params,
      headers: {
...
export class Tool2 extends HeyApiClient {
  /**
   * Update MCP tool enabled state
   *
   * Enable or disable an MCP tool by tool id.
   */
  public enabled<ThrowOnError extends boolean = false>(
    parameters: {
      name: string
...
export class Mcp extends HeyApiClient {
   ...
   * Get MCP tools
   *
   * Get the tool list and connection state for a Model Context Protocol (MCP) server.
   */
   ...
   *
   * Enable or disable a Model Context Protocol (MCP) server.
   */
  public enabled<ThrowOnError extends boolean = false>(
    parameters: {
      name: string
...
export class Session2 extends HeyApiClient {
   ...
   *
   * Regenerate the title for an existing session.
   */
