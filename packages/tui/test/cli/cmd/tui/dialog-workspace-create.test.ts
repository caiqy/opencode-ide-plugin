...
describe("recentConnectedWorkspaces", () => {
  test("returns connected workspaces sorted by time used", () => {
    const workspaces = [
      { id: "wrk_a", name: "alpha", type: "local", timeUsed: 700 },
      { id: "wrk_b", name: "beta", type: "local", timeUsed: 800 },
      { id: "wrk_c", name: "gamma", type: "local", timeUsed: 400 },
      { id: "wrk_d", name: "delta", type: "local", timeUsed: 300 },
      { id: "wrk_e", name: "epsilon", type: "local", timeUsed: 200 },
    ]
    const status = {
      wrk_a: "connected",
      wrk_b: "disconnected",
