...
type Endpoint3_6Request = Parameters<RawClient["server.session"]["session.setApproval"]>[0]
type Endpoint3_6Input = {
  readonly sessionID: Endpoint3_6Request["params"]["sessionID"]
  readonly approval: Endpoint3_6Request["payload"]["approval"]
}
const Endpoint3_6 = (raw: RawClient["server.session"]) => (input: Endpoint3_6Input) =>
  raw["session.setApproval"]({
...
type Endpoint13_0Request = Parameters<RawClient["server.mcp"]["mcp.enabled"]>[0]
type Endpoint13_0Input = {
  readonly name: Endpoint13_0Request["params"]["name"]
  readonly location?: Endpoint13_0Request["query"]["location"]
  readonly enabled: Endpoint13_0Request["payload"]["enabled"]
}
...
type Endpoint13_1Request = Parameters<RawClient["server.mcp"]["mcp.tool.enabled"]>[0]
type Endpoint13_1Input = {
  readonly name: Endpoint13_1Request["params"]["name"]
  readonly toolId: Endpoint13_1Request["params"]["toolId"]
  readonly location?: Endpoint13_1Request["query"]["location"]
  readonly enabled: Endpoint13_1Request["payload"]["enabled"]
}
const Endpoint13_1 = (raw: RawClient["server.mcp"]) => (input: Endpoint13_1Input) =>
  raw["mcp.tool.enabled"]({
    params: { name: input["name"], toolId: input["toolId"] },
    query: { location: input["location"] },
    payload: { enabled: input["enabled"] },
  }).pipe(Effect.mapError(mapClientError))

const adaptGroup13 = (raw: RawClient["server.mcp"]) => ({
  setEnabled: Endpoint13_0(raw),
  setToolEnabled: Endpoint13_1(raw),
})
