...
export type McpSetEnabledOutput = boolean

export type McpSetToolEnabledInput = {
  readonly name: { readonly name: string; readonly toolId: string }["name"]
  readonly toolId: { readonly name: string; readonly toolId: string }["toolId"]
  readonly location?: {
    readonly location?: { readonly directory?: string | undefined; readonly workspace?: string | undefined } | undefined
  }["location"]
  readonly enabled: { readonly enabled: boolean }["enabled"]
...
export type McpSetToolEnabledOutput = boolean
