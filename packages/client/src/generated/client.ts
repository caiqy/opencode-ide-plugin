import type {
  ...
  McpSetEnabledInput,
  McpSetEnabledOutput,
  McpSetToolEnabledInput,
  McpSetToolEnabledOutput,
    ...
    mcp: {
      setEnabled: (input: McpSetEnabledInput, requestOptions?: RequestOptions) =>
        request<McpSetEnabledOutput>(
          {
            method: "PATCH",
            path: `/mcp/${encodeURIComponent(input.name)}/enabled`,
            query: { location: input["location"] },
      ...
      setToolEnabled: (input: McpSetToolEnabledInput, requestOptions?: RequestOptions) =>
        request<McpSetToolEnabledOutput>(
          {
            method: "PATCH",
            path: `/mcp/${encodeURIComponent(input.name)}/tools/${encodeURIComponent(input.toolId)}`,
            query: { location: input["location"] },
            body: { enabled: input["enabled"] },
            successStatus: 200,
            declaredStatuses: [401, 400],
