  ...
  if (isUser) {
    ...
    return (
      <div key={part.id} className="w-full flex justify-end">
        <div className="inline-block w-[min(70%,fit-content)] px-3 py-2 text-sm text-gray-900 dark:text-gray-100 bg-blue-50 dark:bg-blue-900/20 border border-blue-400 dark:border-blue-600">
          <div ref={ref} className="whitespace-pre-wrap break-words" onCopy={handleCopy}>
