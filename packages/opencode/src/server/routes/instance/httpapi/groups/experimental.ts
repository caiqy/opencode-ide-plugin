...
const GlobalSessionList = Schema.suspend(() => Schema.Array(Session.GlobalInfo)).annotate({ identifier: "GlobalSessionList" })
    ...
    HttpApiGroup.make("experimental")
      .add(
        ...
        HttpApiEndpoint.get("session", ExperimentalPaths.session, {
          ...
          success: described(GlobalSessionList, "List of sessions"),
        }).annotateMerge(
          OpenApi.annotations({
