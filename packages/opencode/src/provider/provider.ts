...
export interface Interface {
  ...
  readonly catalogModels: (providerID: ProviderV2.ID) => Effect.Effect<ConfigProviderModelsResult>
...
const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const catalogModels = Effect.fn("Provider.catalogModels")((providerID: ProviderV2.ID) =>
      InstanceState.use(state, (s) => ({
        providerID,
        models: s.catalog[providerID] ? Object.values(toPublicInfo(s.catalog[providerID]).models) : [],
      })),
    )
