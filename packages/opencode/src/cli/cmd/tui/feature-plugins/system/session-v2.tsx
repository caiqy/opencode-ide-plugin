...
type SessionMessageAgentSwitched = { id: string; type: "agent-switched"; agent: string; time: { created: number } }
type SessionMessageModelSwitched = {
  id: string
  type: "model-switched"
...
type SessionMessageSynthetic = { id: string; type: "synthetic"; text: string; sessionID: string; time: { created: number } }
...
type SessionMessageAssistantText = { type: "text"; text: string }
...
type SessionMessageAssistantTool = {
  ...
  state:
    ...
    | { status: "running"; input: Record<string, unknown>; structured: Record<string, unknown>; content: Array<ToolTextContent | ToolFileContent> }
    | { status: "completed"; input: Record<string, unknown>; structured: Record<string, unknown>; content: Array<ToolTextContent | ToolFileContent> }
    | {
        status: "error"
