...
test("custom provider Responses streams are not filtered", async () => {
  ...
  globalThis.fetch = (async () =>
    new Response(
      'data: {"id":"chatcmpl-real","object":"chat.completion.chunk","choices":[{"index":0,"delta":{"content":"custom text"}}]}\n\n',
  ...
  try {
    ...
    await withTestInstance({
      ...
      fn: async (ctx) => {
        ...
        expect(await response.text()).toContain("custom text")
      },
    })
  } finally {
