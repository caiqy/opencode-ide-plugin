export const dict = {
  ...
  "provider.custom.field.providerID.description": "Lettres minuscules, chiffres, traits d'union ou traits de soulignement",
  ...
  "provider.custom.field.apiKey.description": "Facultatif. Laissez ce champ vide si vous gérez l'authentification au moyen des en-têtes.",
  ...
  "provider.custom.error.providerID.format": "Utilisez des lettres minuscules, des chiffres, des traits d'union ou des traits de soulignement",
  ...
  "toast.session.unshare.failed.description": "Une erreur s'est produite lors de la désactivation du partage de la session",
  ...
  "settings.general.row.releaseNotes.description": "Afficher les fenêtres contextuelles « Quoi de neuf » après les mises à jour",
  ...
  "settings.updates.row.check.description": "Rechercher manuellement les mises à jour et installer toute mise à jour disponible",
