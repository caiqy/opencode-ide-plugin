export const dict = {
  ...
  "settings.general.row.colorScheme.description": "Vælg, om OpenCode skal følge systemtemaet eller bruge et lyst eller mørkt tema",
  ...
  "settings.general.row.showCustomAgents.description": "Skift mellem agenter i promptfeltet. Når vælgeren er skjult, bruges Build-agenten som standard.",
